...
def get_args():
    ...
    parser.add("--decay_bd", type=int, default=[150,225], help="Learning rate decay boundary, default=[50,75]")
    parser.add("--gamma", type=float, default=0.1, help="Learning rate decay rate, default=0.1")
    parser.add("--num_epochs", type=int, default=300, help="Training epochs, default=100")
